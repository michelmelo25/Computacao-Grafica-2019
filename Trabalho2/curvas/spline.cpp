...
Spline::Spline()
{
    P = new Vetor3D[4]; //Só jesus na causa
    this->setTipo(1);  //começa na interpoladora
}

void Spline::atualizarPontosDeControle(vector<Vetor3D> pontosDeControle){
    Pn.clear();
